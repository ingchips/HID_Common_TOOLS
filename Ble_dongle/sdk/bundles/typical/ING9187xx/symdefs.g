...
eTaskConfirmSleepModeStatus = 0x00006db1;
...
gap_disconnect2 = 0x0000740d;
gap_disconnect_all = 0x00007439;
gap_ext_create_connection = 0x00007479;
gap_get_connection_parameter_range = 0x00007551;
gap_le_read_channel_map = 0x00007589;
gap_periodic_adv_create_sync = 0x000075e9;
gap_periodic_adv_create_sync_cancel = 0x0000760d;
gap_periodic_adv_term_sync = 0x00007619;
gap_read_periodic_adv_list_size = 0x000076a1;
gap_read_phy = 0x000076ad;
gap_read_remote_used_features = 0x000076b9;
gap_read_remote_version = 0x000076c5;
gap_read_rssi = 0x000076d1;
gap_read_white_lists_size = 0x000076dd;
gap_remove_whitelist = 0x000076e9;
gap_rmv_adv_set = 0x00007765;
gap_rmv_dev_from_periodic_list = 0x00007771;
gap_rx_test_v2 = 0x00007781;
gap_set_adv_set_random_addr = 0x000077b9;
gap_set_callback_for_next_hci = 0x000077dd;
gap_set_connection_parameter_range = 0x000077fd;
gap_set_data_length = 0x00007815;
gap_set_def_phy = 0x0000782d;
gap_set_ext_adv_data = 0x0000783d;
gap_set_ext_adv_enable = 0x00007855;
gap_set_ext_adv_para = 0x000078c5;
...
gap_start_ccm = 0x00007b3d;
gap_test_end = 0x00007b85;
gap_tx_test_v2 = 0x00007b91;
gap_tx_test_v4 = 0x00007ba9;
gap_update_connection_parameters = 0x00007bcd;
...
gatt_client_is_ready = 0x00008425;
gatt_client_listen_for_characteristic_value_updates = 0x0000843b;
gatt_client_prepare_write = 0x0000845d;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x00008499;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x000084c3;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x000084c9;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x000084f7;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x000084fd;
gatt_client_read_multiple_characteristic_values = 0x0000852b;
gatt_client_read_value_of_characteristic_using_value_handle = 0x0000855b;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x00008589;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x000085d5;
gatt_client_register_handler = 0x00008621;
gatt_client_reliable_write_long_value_of_characteristic = 0x0000862d;
gatt_client_signed_write_without_response = 0x00008a5d;
gatt_client_write_characteristic_descriptor_using_descriptor_handle = 0x00008b21;
gatt_client_write_client_characteristic_configuration = 0x00008b5b;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle = 0x00008bad;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008bbd;
gatt_client_write_long_value_of_characteristic = 0x00008bf9;
gatt_client_write_long_value_of_characteristic_with_offset = 0x00008c09;
gatt_client_write_value_of_characteristic = 0x00008c45;
gatt_client_write_value_of_characteristic_without_response = 0x00008c7b;
hci_add_event_handler = 0x0000a199;
hci_power_control = 0x0000a931;
hci_register_acl_packet_handler = 0x0000aae5;
kv_commit = 0x0000b229;
kv_get = 0x0000b285;
kv_init = 0x0000b291;
kv_init_backend = 0x0000b311;
kv_put = 0x0000b325;
kv_remove = 0x0000b331;
kv_remove_all = 0x0000b365;
kv_value_modified = 0x0000b395;
kv_value_modified_of_key = 0x0000b3b1;
kv_visit = 0x0000b3bd;
l2cap_add_event_handler = 0x0000b44d;
l2cap_can_send_packet_now = 0x0000b45d;
l2cap_create_le_credit_based_connection_request = 0x0000b619;
l2cap_credit_based_send = 0x0000b75d;
l2cap_credit_based_send_continue = 0x0000b789;
l2cap_disconnect = 0x0000b805;
l2cap_get_le_credit_based_connection_credits = 0x0000ba4d;
l2cap_get_peer_mtu_for_local_cid = 0x0000ba69;
l2cap_init = 0x0000be29;
l2cap_le_send_flow_control_credit = 0x0000bf1d;
l2cap_max_le_mtu = 0x0000c219;
l2cap_register_packet_handler = 0x0000c341;
l2cap_register_service = 0x0000c34d;
l2cap_request_can_send_now_event = 0x0000c45d;
l2cap_request_connection_parameter_update = 0x0000c477;
l2cap_send_echo_request = 0x0000c945;
l2cap_unregister_service = 0x0000ca05;
le_device_db_add = 0x0000ca5d;
...
ll_aes_encrypt = 0x0000cbcd;
ll_config = 0x0000cc49;
ll_free = 0x0000cc7f;
ll_get_capabilities = 0x0000cc89;
ll_get_heap_free_size = 0x0000cca9;
ll_get_states = 0x0000ccb9;
ll_hint_on_ce_len = 0x0000cd75;
ll_legacy_adv_set_interval = 0x0000cdad;
ll_malloc = 0x0000cdbd;
ll_query_timing_info = 0x0000cef5;
ll_register_hci_acl_previewer = 0x0000cf41;
ll_scan_set_fixed_channel = 0x0000cfa5;
ll_set_adv_access_address = 0x0000d1bd;
ll_set_adv_coded_scheme = 0x0000d1c9;
ll_set_conn_acl_report_latency = 0x0000d1f9;
ll_set_conn_coded_scheme = 0x0000d229;
ll_set_conn_latency = 0x0000d255;
ll_set_conn_tx_power = 0x0000d285;
